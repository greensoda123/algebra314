...
assets/general-triangle.png
assets/345-triangle.png
assets/51213-triangle.png
assets/40941-triangle.png
assets/scaling-triangles.png
assets/desmos-n6.png
-->

# The Congruent Number Problem: From Right-Angled Triangles to Elliptic Curves
...
$$
h(n)=\#\{(x,y,z)\in\mathbb{Z}^3:x^2+4y^2+8z^2=\frac{n}{2}\}
$$
...
Here, \(\#\) means “the number of”, so \(h(n)\) and \(k(n)\) count how many integer triples \((x,y,z)\) satisfy the equation.
...
$$
h(2)=\#\{(x,y,z)\in\mathbb{Z}^3:x^2+4y^2+8z^2=1\}
$$

and:

$$
k(2)=\#\{(x,y,z)\in\mathbb{Z}^3:x^2+4y^2+32z^2=1\}
$$
