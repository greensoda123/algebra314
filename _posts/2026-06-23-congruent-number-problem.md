...
description: "An exploration of congruent numbers, Pythagorean triples, scaling, elliptic curves, and Tunnell's theorem."
date: 2026-06-23
tags: \[maths, number-theory, elliptic-curves]
math: true
---

<!--
Image paths used in this post:
{{ "/assets/general-triangle.png" | relative\_url }}
{{ "/assets/345-triangle.png" | relative\_url }}
{{ "/assets/51213-triangle.png" | relative\_url }}
{{ "/assets/40941-triangle.png" | relative\_url }}
{{ "/assets/scaling-triangles.png" | relative\_url }}
{{ "/assets/desmos-n6.png" | relative\_url }}
...
!\[A general right-angled triangle with side lengths a, b, c and area n]({{ "/assets/general-triangle.png" | relative\_url }})
...
!\[A 3, 4, 5 triangle with area 6]({{ "/assets/345-triangle.png" | relative\_url }})
...
!\[A 5, 12, 13 triangle with area 30]({{ "/assets/51213-triangle.png" | relative\_url }})
...
!\[A 40, 9, 41 triangle with area 180]({{ "/assets/40941-triangle.png" | relative\_url }})
...
!\[A rational triangle with area 5 scaled by 6 into the 40, 9, 41 triangle with area 180]({{ "/assets/scaling-triangles.png" | relative\_url }})
...
<details>
<summary>Example with k = 4 and l = 3</summary>
...
<details>
<summary>Example with k = 3 and l = 2</summary>
...
!\[The elliptic curve y^2 = x^3 - n^2x with n = 6, showing the point (12,36)]({{ "/assets/desmos-n6.png" | relative\_url }})
